...
Locale['chat_label_message'] = 'Message'
...
Locale['ad_title'] = 'Advertisement'
Locale['twt_title'] = 'Twitter'

Locale['stav_disabled'] = 'The /stav command is currently disabled.'
Locale['stav_removed'] = 'Status display removed.'
Locale['zde_disabled'] = 'The /zde command is currently disabled.'
Locale['zde_limit'] = 'You cannot post another message here. You would exceed the limit.'
Locale['zde_removed'] = 'You are disabling text display here.'
Locale['zde_exists'] = 'There is already text here.'
Locale['zde_not_spawned'] = 'You must be spawned to write /zde.'
